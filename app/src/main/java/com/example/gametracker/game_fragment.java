...
public class game_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title = view.findViewById(R.id.tvTitleGame);
        desc = view.findViewById(R.id.tvDescGame);
        producer = view.findViewById(R.id.tvProducerGame);
        publisher = view.findViewById(R.id.tvPublisherGame);
        date = view.findViewById(R.id.tvDateGame);
        genre = view.findViewById(R.id.tvGenreGame);
        mode = view.findViewById(R.id.tvModeGame);
        platform = view.findViewById(R.id.tvPlatformGame);
        ivfront = view.findViewById(R.id.ivFrontGame);
        ...
        film = view.findViewById(R.id.ibTrailerGame);
